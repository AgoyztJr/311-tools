...
echo -b "AUTHOR    : KAX AGOYZT JR $green " |lolcat
...
sleep 1
echo -b $green"[#]> KAX AGOYZT JR On Your System" |lolcat
...
00) echo "AUTHOR: KAX AGOYZT JR" | lolcat
